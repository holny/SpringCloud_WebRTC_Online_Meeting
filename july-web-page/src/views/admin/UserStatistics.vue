<template>
  <div class="column">
    <div class="col">
      <div class="text-bold text-h5 text-center q-mb-lg">用户数据统计</div>
    </div>
    <div class="col">
...
import GuageChart from "@/views/charts/GuageChart";
import AreaChart from "@/views/charts/AreaChart";
export default {
  name: "UserStatistics",
  components: {AreaChart, GuageChart, PieChart, BarChart, LineChart}
}
</script>
