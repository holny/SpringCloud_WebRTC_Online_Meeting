...
export let CONSTANT = {
    ...
    CONSULT_SPECIAL_MAX_REACH_DAYS:60,

    USER_LEVEL_EXP_INTERNAL: 50,

    VIDEO_STATUS_DELETE:0,
    VIDEO_STATUS_IN_PROCESS:1,
    VIDEO_STATUS_PRIVATE:2,
    VIDEO_STATUS_PUBLIC:3,
    VIDEO_STATUS_LOCKED:4,
}
