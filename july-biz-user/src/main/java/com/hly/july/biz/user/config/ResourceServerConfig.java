package com.hly.july.biz.user.config;

import com.hly.july.common.auth.exception.CustomAccessDeniedHandler;
import com.hly.july.common.auth.exception.CustomAuthenticationEntryPoint;
import com.hly.july.common.auth.properties.RSAKeyProperties;
import com.hly.july.common.web.filter.TokenAuthenticationFilter;
...
//                .and().csrf().disable()
//                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS);    // JWT 设置spring security 无状态，STATELESS不使用任何session，
