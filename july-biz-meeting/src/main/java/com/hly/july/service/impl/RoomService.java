...
public class RoomService {
    ...
    private String REDIS_PREFIX_ROOM_MEMBER = "meeting_room_member_";
...
//            }
    ...
    public Result<String> sendRoomMessage(String roomId, MessageVO message) {
    ...
    public Result<String> sendPersonalMessage(String userId,String hostId, MessageVO message) {
